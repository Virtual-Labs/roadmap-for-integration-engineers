...
refer to the tutorial on [[http://www.gnu.org/software/make/manual/make.pdf}{Understanding][How to Write Make]].
...
[[./labspec.json][here]]. The template to populate your own labspec can be found [[./labbspec-template.json][here]].
